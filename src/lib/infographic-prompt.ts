...
- Position & size: horizontally centred and attached to the BOTTOM edge of the image — the card must physically protrude UP out of the bottom edge (its lower portion runs off the bottom of the frame), NOT float freely in the middle. Give it a three-dimensional "plastic" relief — real depth and a soft shadow — so it clearly reads as a solid widget emerging from the bottom edge. Make the card generous: about one third larger in BOTH width and height than a minimal label would be.
